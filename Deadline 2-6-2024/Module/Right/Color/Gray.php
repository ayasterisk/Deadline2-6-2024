...
<div class="head-right"><h3>Gray</h3></div>
    ...
    <div class="sanpham">
        <div class="pagination">
          <a href="index.php?xem=Gray&id=1">&laquo;</a>
          <a href="index.php?xem=Gray&id=1" class="active">1</a>
          <a href="index.php?xem=Gray&id=2">2</a>
          <a href="index.php?xem=Gray&id=3">3</a>
          <a href="index.php?xem=Gray&id=4">4</a>
          <a href="index.php?xem=Gray&id=5">5</a>
          <a href="index.php?xem=Gray&id=2">&raquo;</a>
        </div>
      </div>